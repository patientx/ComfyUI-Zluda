...
(06.02) :: Updated ZLUDA version and also torch version, also added Comfyui-Impact-Pack auto install. A lot of important stuff for people coming from other sd-webuis.So it is recommended to run install.bat once again for a clean overall update.
